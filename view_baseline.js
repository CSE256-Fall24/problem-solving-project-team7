...
perm_dialog.append($('<div id="permissions_user_title"> If user is unable to modify a file but all seetings look right, go to Advanced change --> edit --> the groupd they belong to --> and see if there are any permissions being denied. </div>'))
